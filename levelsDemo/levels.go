...
func main() {
	...
	log.S(log.Info, "This is structured info message with 2 attributes",
		log.Str("attr1", "value1"), log.Attr("attr2", 42))
	...
	fmt.Println("This is a regular output, will get prefixed with a exclamation point")
}
